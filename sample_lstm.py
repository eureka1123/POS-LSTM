...
with open("data/main_dictionary_size_new_100K_3712.txt", "r") as file:
...
x_train = main_dict["encoded_input"][:3000]
y_train = main_dict["encoded_label"][:3000]

x_test = main_dict["encoded_input"][3000:3200]
y_test = main_dict["encoded_label"][3000:3200]
...
#emb2 = Dense(128, activation='tanh')(emb)
...
out = TimeDistributed(Dense(no_cat+1, activation='softmax'))(dense)
